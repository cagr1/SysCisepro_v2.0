...
Namespace ACTIVOS_FIJOS.TIPOS_DE_ACTIVOS
    Public Class ClassChalecos
        ...
        Public Function NuevoChaleco() As SqlCommand
            Dim comando = New SqlCommand
            With comando
                .CommandType = CommandType.StoredProcedure
                .CommandText = "nuevoChaleco"
        ...
        Public Function SeleccionarTodosLosRegistrosChalecos(ByVal tipoCon As TipoConexion) As DataSet
            Dim mant = ComandosSql.SeleccionarQueryToDataAdapter(tipoCon, "SeleccionarTodosLosRegistrosChalecos", True)

            Dim ds = New DataSet()
            mant.Fill(ds, "CHALECOS")
            mant.Fill(ds, "ACTIVO_FIJO_GENERAL")
            Return ds
        End Function

        Public Function SeleccionarIngresosChaleco(ByVal tipoCon As TipoConexion) As DataSet
            Dim obje = ComandosSql.SeleccionarQueryToDataAdapter(tipoCon, "SELECT * FROM dbo.CHALECOS WHERE ESTADO=1", False)
