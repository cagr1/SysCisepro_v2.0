...
Namespace ACTIVOS_FIJOS.TIPOS_DE_ACTIVOS
    Public Class ClassEquipoComputo
        ''' <summary>
        ...
        Public EstadoComponente As String
        Public ColorComponente As String
        ...
        Public Function NuevaEquipoComputo() As SqlCommand
            Dim comando = New SqlCommand
            With comando
                .CommandType = CommandType.StoredProcedure
                .CommandText = "nuevaEquipoComputo"
                ...
                .Parameters.AddWithValue("@COMPONENTE", SqlDbType.NVarChar).Value = Componente
                .Parameters.AddWithValue("@ESTADO_COMPONENTE", SqlDbType.NVarChar).Value = EstadoComponente
                .Parameters.AddWithValue("@COLOR_COMPONENTE", SqlDbType.NVarChar).Value = ColorComponente
                .Parameters.AddWithValue("@CODIGO_COMPONENTE", SqlDbType.NVarChar).Value = CodigoComponente
        ...
        Public Function SeleccionarTodosLosRegistrosEquiposComputo(ByVal tipoCon As TipoConexion) As DataSet
            Dim mant = ComandosSql.SeleccionarQueryToDataAdapter(tipoCon, "SeleccionarTodosLosRegistrosEquiposComputo", True)

            Dim ds = New DataSet()
            mant.Fill(ds, "EQUIPOS_COMPUTO")
            mant.Fill(ds, "ACTIVO_FIJO_GENERAL")
            Return ds
        End Function

        Public Function SeleccionarIngresosEquiposDeComputo(ByVal tipoCon As TipoConexion) As DataSet
            Dim obje = ComandosSql.SeleccionarQueryToDataAdapter(tipoCon, "SELECT * FROM  dbo.EQUIPOS_COMPUTO  WHERE  ESTADO=1", False)
