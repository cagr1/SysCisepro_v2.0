...
Namespace ACTIVOS_FIJOS.TIPOS_DE_ACTIVOS
    Public Class ClassEquiposComunicacion
        ''' <summary>
        ...
        Public InicioPermisoFrecuencia As DateTime
        Public FinalPermisoFrecuencia As DateTime
        ...
        Public Function NuevaEquipoComunicacion() As SqlCommand
            Dim comando = New SqlCommand
            With comando
                .CommandType = CommandType.StoredProcedure
                .CommandText = "nuevaEquipoComunicacion"
                ...
                .Parameters.AddWithValue("@INICIO_PERMISO_FRECUENCIA", SqlDbType.DateTime).Value = InicioPermisoFrecuencia
                .Parameters.AddWithValue("@FINAL_PERMISO_FRECUENCIA", SqlDbType.DateTime).Value = FinalPermisoFrecuencia
        ...
        Public Function SeleccionarTodosLosRegistrosEquiposComunicacion(ByVal tipoCon As TipoConexion) As DataSet
            Dim mant = ComandosSql.SeleccionarQueryToDataAdapter(tipoCon, "SeleccionarTodosLosRegistrosEquiposComunicacion", True)

            Dim ds = New DataSet()
            mant.Fill(ds, "EQUIPOS_COMUNICACION_TELEFONIA")
            mant.Fill(ds, "ACTIVO_FIJO_GENERAL")
            Return ds
        End Function

        Public Function SeleccionarIngresosEquiposDeComunicacion(ByVal tipoCon As TipoConexion) As DataSet
            Dim obje = ComandosSql.SeleccionarQueryToDataAdapter(tipoCon, "SELECT * FROM  dbo.EQUIPOS_COMUNICACION  WHERE  ESTADO=1", False)
            ...
            Dim ds = New DataSet()
            obje.Fill(ds, "EQUIPOS_COMUNICACION_TELEFONIA")
