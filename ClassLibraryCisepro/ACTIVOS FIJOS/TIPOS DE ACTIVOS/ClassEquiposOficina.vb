...
Namespace ACTIVOS_FIJOS.TIPOS_DE_ACTIVOS
    Public Class ClassEquiposOficina
        ''' <summary>
        ...
        Public Function NuevoEquiposOficina() As SqlCommand
            Dim comando = New SqlCommand
            With comando
                .CommandType = CommandType.StoredProcedure
                .CommandText = "NuevoEquiposOficina"
        ...
        Public Function SeleccionarTodosLosRegistrosEquiposOficina(ByVal tipoCon As TipoConexion) As DataSet
            Dim mant = ComandosSql.SeleccionarQueryToDataAdapter(tipoCon, "SeleccionarTodosLosRegistrosEquiposOficina", True)

            Dim ds = New DataSet()
            mant.Fill(ds, "EQUIPOS_OFICINA")
            mant.Fill(ds, "ACTIVO_FIJO_GENERAL")
            Return ds
        End Function

        Public Function SeleccionarIngresosEquiposDeOficina(ByVal tipoCon As TipoConexion) As DataSet
            Dim obje = ComandosSql.SeleccionarQueryToDataAdapter(tipoCon, "SELECT * FROM  dbo.EQUIPOS_OFICINA  WHERE  ESTADO=1", False)
