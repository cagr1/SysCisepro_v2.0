...
Namespace ACTIVOS_FIJOS.TIPOS_DE_ACTIVOS
    Public Class ClassEquiposSeguridad
        ''' <summary>
        ...
        Public Function NuevaEquipoSeguridad() As SqlCommand
            Dim comando = New SqlCommand
            With comando
                .CommandType = CommandType.StoredProcedure
                .CommandText = "nuevaEquipoSeguridad"
                ...
                .Parameters.AddWithValue("@ADICIONAL", SqlDbType.NVarChar).Value = Adicional
                .Parameters.AddWithValue("@ESTADO", SqlDbType.Int).Value = Estado
            End With
            Return comando
        End Function
         
        Public Function SeleccionarTodosLosRegistrosEquiposSeguridad(ByVal tipoCon As TipoConexion) As DataSet
            Dim mant = ComandosSql.SeleccionarQueryToDataAdapter(tipoCon, "SeleccionarTodosLosRegistrosEquiposSeguridad", True) 

            Dim ds = New DataSet()
            mant.Fill(ds, "EQUIPOS_SEGURIDAD_INDUSTRIAL")
            mant.Fill(ds, "ACTIVO_FIJO_GENERAL")
            Return ds
        End Function

        Public Function SeleccionarIngresosEquiposDeSeguridad(ByVal tipoCon As TipoConexion) As DataSet
            Dim obje = ComandosSql.SeleccionarQueryToDataAdapter(tipoCon, "SELECT * FROM  dbo.EQUIPOS_SEGURIDAD_INDUSTRIAL  WHERE  ESTADO=1", False)
            ...
            Dim ds = New DataSet()
            obje.Fill(ds, "EQUIPOS_SEGURIDAD_INDUSTRIAL")
