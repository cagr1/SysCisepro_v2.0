...
Namespace ACTIVOS_FIJOS.TIPOS_DE_ACTIVOS
    Public Class ClassRadios
        ...
        Public NumPermisoUso As String
        Public FecAceptacionPermiso As DateTime
        Public FecCaducidadPermiso As DateTime
        ...
        Public Function NuevoRadios() As SqlCommand
            Dim comando = New SqlCommand
            With comando
                .CommandType = CommandType.StoredProcedure
                .CommandText = "NuevoRadios"
                ...
                .Parameters.AddWithValue("@NUM_PERMISO_USO", SqlDbType.NVarChar).Value = NumPermisoUso
                .Parameters.AddWithValue("@FEC_ACEPTACION_PERMISO", SqlDbType.DateTime).Value = FecAceptacionPermiso
                .Parameters.AddWithValue("@FEC_CADUCIDAD_PERMISO", SqlDbType.DateTime).Value = FecCaducidadPermiso
        ...
        Public Function SeleccionarTodosLosRegistrosRadios(ByVal tipoCon As TipoConexion) As DataSet
            Dim mant = ComandosSql.SeleccionarQueryToDataAdapter(tipoCon, "SeleccionarTodosLosRegistrosRadios", True) 
        ...
        Public Function SeleccionarIngresosRadios(ByVal tipoCon As TipoConexion) As DataSet
            Dim obje = ComandosSql.SeleccionarQueryToDataAdapter(tipoCon, "SELECT * FROM  dbo.RADIOS  WHERE  ESTADO=1", False) 
