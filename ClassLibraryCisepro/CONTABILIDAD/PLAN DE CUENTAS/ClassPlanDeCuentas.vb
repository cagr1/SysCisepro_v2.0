...
Namespace CONTABILIDAD.PLAN_DE_CUENTAS
    Public Class ClassPlanDeCuentas
        ...
        Public Function SeleccionarSaldosMayoresXFechaDiario2(ByVal tipoCon As TipoConexion, ByVal fechaBusquedaInicial As DateTime, ByVal fechaBusquedaFinal As DateTime) As DataTable
            ...
            Return ComandosSql.SeleccionarQueryWithParamsToDataTable(tipoCon, "SELECT dbo.ASIENTOS_LIBRO_DIARIO.CODIGO_CUENTA_ASIENTO  AS 'CODIGO', dbo.ASIENTOS_LIBRO_DIARIO.NOMBRE_CUENTA_ASIENTO AS 'CUENTA', INICIAL = '0.0', SUM(dbo.ASIENTOS_LIBRO_DIARIO.VALOR_DEBE_ASIENTO)  AS 'DEBE', SUM(dbo.ASIENTOS_LIBRO_DIARIO.VALOR_HABER_ASIENTO) AS 'HABER', SUM(dbo.ASIENTOS_LIBRO_DIARIO.VALOR_DEBE_ASIENTO)-SUM(dbo.ASIENTOS_LIBRO_DIARIO.VALOR_HABER_ASIENTO) AS 'SALDO', dbo.PLAN_CUENTAS_GENERAL.NIVEL AS 'NIVEL', dbo.PLAN_CUENTAS_GENERAL.PADRE_CUENTA AS 'PADRE' FROM dbo.ASIENTOS_LIBRO_DIARIO, dbo.PLAN_CUENTAS_GENERAL WHERE dbo.ASIENTOS_LIBRO_DIARIO.FECHA_ASIENTO BETWEEN @FECHA_INICIAL AND @FECHA_FINAL AND dbo.ASIENTOS_LIBRO_DIARIO.ESTADO_ASIENTO>0 and dbo.PLAN_CUENTAS_GENERAL.CODIGO=dbo.ASIENTOS_LIBRO_DIARIO.CODIGO_CUENTA_ASIENTO and dbo.PLAN_CUENTAS_GENERAL.estado = 1 GROUP BY dbo.ASIENTOS_LIBRO_DIARIO.CODIGO_CUENTA_ASIENTO, dbo.ASIENTOS_LIBRO_DIARIO.NOMBRE_CUENTA_ASIENTO, dbo.PLAN_CUENTAS_GENERAL.NIVEL, dbo.PLAN_CUENTAS_GENERAL.PADRE_CUENTA ORDER BY CODIGO ;", False, pars)
        End Function
        ...
        Public Function SeleccionarSaldosMayoresXFechaDiarioMensual2(ByVal tipoCon As TipoConexion, ByVal anio As Integer) As DataTable 
            ...
            'Cambio 2023 
            Return ComandosSql.SeleccionarQueryWithParamsToDataTable(tipoCon, "SELECT PC.CODIGO, PC.DETALLE AS 'CUENTA', INICIAL = (SELECT ABS(AD.VALOR_DEBE_ASIENTO - AD.VALOR_HABER_ASIENTO) FROM ASIENTOS_LIBRO_DIARIO AD WHERE AD.ESTADO_ASIENTO = 2 AND AD.CONCEPTO_ASIENTO = 'ESTADO SITUACION INICIAL ' + convert(varchar,@ANIO) AND AD.CODIGO_CUENTA_ASIENTO =PC.CODIGO), DEBE='0.0', HABER='0.0', SALDO='0.0', PC.NIVEL AS 'NIVEL', PC.PADRE_CUENTA AS 'PADRE' FROM PLAN_CUENTAS_GENERAL PC WHERE PC.ESTADO = 1 ORDER BY PC.CODIGO;", False, pars)
        ...
        Public Function SeleccionarSaldosMayoresXFechaDiarioBalanceFinal2(ByVal tipoCon As TipoConexion, ByVal fechaBusquedaInicial As DateTime, ByVal fechaBusquedaFinal As DateTime) As DataTable
            ...
            pars.Add(New Object() {"FECHA_INICIAL", SqlDbType.VarChar, fechaBusquedaInicial})
            pars.Add(New Object() {"FECHA_FINAL", SqlDbType.VarChar, fechaBusquedaFinal})
            Return ComandosSql.SeleccionarQueryWithParamsToDataTable(tipoCon, "SELECT dbo.ASIENTOS_LIBRO_DIARIO.CODIGO_CUENTA_ASIENTO  AS 'CODIGO', dbo.ASIENTOS_LIBRO_DIARIO.NOMBRE_CUENTA_ASIENTO AS 'CUENTA', INICIAL = '0.0', SUM(dbo.ASIENTOS_LIBRO_DIARIO.VALOR_DEBE_ASIENTO)  AS 'DEBE', SUM(dbo.ASIENTOS_LIBRO_DIARIO.VALOR_HABER_ASIENTO) AS 'HABER', SUM(dbo.ASIENTOS_LIBRO_DIARIO.VALOR_DEBE_ASIENTO)-SUM(dbo.ASIENTOS_LIBRO_DIARIO.VALOR_HABER_ASIENTO) AS 'SALDO', dbo.PLAN_CUENTAS_GENERAL.NIVEL AS 'NIVEL', dbo.PLAN_CUENTAS_GENERAL.PADRE_CUENTA AS 'PADRE', dbo.PLAN_CUENTAS_GENERAL.MOVIMIENTO AS 'MOVIMIENTO' FROM dbo.ASIENTOS_LIBRO_DIARIO, dbo.PLAN_CUENTAS_GENERAL WHERE dbo.ASIENTOS_LIBRO_DIARIO.FECHA_ASIENTO BETWEEN @FECHA_INICIAL AND @FECHA_FINAL AND dbo.ASIENTOS_LIBRO_DIARIO.ESTADO_ASIENTO>0 and dbo.PLAN_CUENTAS_GENERAL.CODIGO=dbo.ASIENTOS_LIBRO_DIARIO.CODIGO_CUENTA_ASIENTO and dbo.PLAN_CUENTAS_GENERAL.TIPO_CUENTA<4 and dbo.PLAN_CUENTAS_GENERAL.estado=1 GROUP BY dbo.ASIENTOS_LIBRO_DIARIO.CODIGO_CUENTA_ASIENTO, dbo.ASIENTOS_LIBRO_DIARIO.NOMBRE_CUENTA_ASIENTO, dbo.PLAN_CUENTAS_GENERAL.NIVEL, dbo.PLAN_CUENTAS_GENERAL.PADRE_CUENTA, dbo.PLAN_CUENTAS_GENERAL.MOVIMIENTO ORDER BY CODIGO;", False, pars)
        ...
        Public Function SeleccionarSaldosMayoresXFechaDiarioBalanceFinalMensual2(ByVal tipoCon As TipoConexion, ByVal anio As Integer) As DataTable
            ...
            'Cambio 2023 
            Return ComandosSql.SeleccionarQueryWithParamsToDataTable(tipoCon, "SELECT PC.CODIGO, PC.DETALLE AS 'CUENTA', INICIAL = (SELECT ABS(AD.VALOR_DEBE_ASIENTO - AD.VALOR_HABER_ASIENTO) FROM ASIENTOS_LIBRO_DIARIO AD WHERE AD.ESTADO_ASIENTO = 2 AND AD.CONCEPTO_ASIENTO = 'ESTADO SITUACION INICIAL ' + convert(varchar,@ANIO) AND AD.CODIGO_CUENTA_ASIENTO =PC.CODIGO), DEBE='0.0', HABER='0.0', SALDO='0.0', PC.NIVEL AS 'NIVEL', PC.PADRE_CUENTA AS 'PADRE' FROM PLAN_CUENTAS_GENERAL PC WHERE PC.TIPO_CUENTA < 4 AND PC.ESTADO = 1 ORDER BY PC.CODIGO;", False, pars)
        End Function
