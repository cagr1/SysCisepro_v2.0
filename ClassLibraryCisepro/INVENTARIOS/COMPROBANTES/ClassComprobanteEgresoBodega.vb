...
Namespace INVENTARIOS.COMPROBANTES
    Public Class ClassComprobanteEgresoBodega
        ...
        Public Function SeleccionarComprobanteEgresoBodegaxRengoFechas(ByVal tipoCon As TipoConexion, ByVal parametroFechaInicial As DateTime, ByVal parametroFechaFinal As DateTime, ByVal filtro As String) As DataTable
            Dim pars = New List(Of Object())
