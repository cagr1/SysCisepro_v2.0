...
Partial Public Class DsLiquidacionesCajaFondo
    ...
    Partial Public Class LIQUIDACIONES_FONDO_ROTATIVODataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Overloads Function AddLIQUIDACIONES_FONDO_ROTATIVORow(ByVal NRO As String, ByVal CONCEPTO As String, ByVal DETALLE As String, ByVal RECEPTOR As String, ByVal TIPDOC As String, ByVal NDOC As String, ByVal VALOR As String) As LIQUIDACIONES_FONDO_ROTATIVORow
            ...
            Dim columnValuesArray() As Object = New Object() {NRO, CONCEPTO, DETALLE, RECEPTOR, TIPDOC, NDOC, VALOR}
