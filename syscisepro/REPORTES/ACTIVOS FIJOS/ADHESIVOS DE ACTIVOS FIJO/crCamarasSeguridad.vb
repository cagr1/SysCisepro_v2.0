...
Public Class crCamarasSeguridad
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "syscisepro.crCamarasSeguridad.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrCamarasSeguridad
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crCamarasSeguridad = New crCamarasSeguridad()
        rpt.Site = Me.Site
        Return rpt
    End Function
