...
Public Class crEquiposCocina
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "syscisepro.crEquiposCocina.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrEquiposCocina
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crEquiposCocina = New crEquiposCocina()
        rpt.Site = Me.Site
        Return rpt
    End Function
