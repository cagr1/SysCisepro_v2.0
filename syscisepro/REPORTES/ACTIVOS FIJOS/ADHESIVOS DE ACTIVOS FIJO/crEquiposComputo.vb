...
Public Class crEquiposComputo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "syscisepro.crEquiposComputo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrEquiposComputo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crEquiposComputo = New crEquiposComputo()
        rpt.Site = Me.Site
        Return rpt
    End Function
