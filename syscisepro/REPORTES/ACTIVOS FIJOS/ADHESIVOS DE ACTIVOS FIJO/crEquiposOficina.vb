...
Public Class crEquiposOficina
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "syscisepro.crEquiposOficina.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrEquiposOficina
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crEquiposOficina = New crEquiposOficina()
        rpt.Site = Me.Site
        Return rpt
    End Function
