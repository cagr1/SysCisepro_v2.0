...
Public Class crEquiposSeguridad
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "syscisepro.crEquiposSeguridad.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrEquiposSeguridad
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crEquiposSeguridad = New crEquiposSeguridad()
        rpt.Site = Me.Site
        Return rpt
    End Function
