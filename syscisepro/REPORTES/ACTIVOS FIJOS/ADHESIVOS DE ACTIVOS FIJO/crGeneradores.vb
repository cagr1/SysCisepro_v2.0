...
Public Class crGeneradores
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "syscisepro.crGeneradores.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrGeneradores
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crGeneradores = New crGeneradores()
        rpt.Site = Me.Site
        Return rpt
    End Function
