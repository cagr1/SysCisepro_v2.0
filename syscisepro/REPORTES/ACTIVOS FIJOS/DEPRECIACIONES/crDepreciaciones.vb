...
Public Class crDepreciaciones
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "syscisepro.crDepreciaciones.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrDepreciaciones
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crDepreciaciones = New crDepreciaciones()
        rpt.Site = Me.Site
        Return rpt
    End Function
