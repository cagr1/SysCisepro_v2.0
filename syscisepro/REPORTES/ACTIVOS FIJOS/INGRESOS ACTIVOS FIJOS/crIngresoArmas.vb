...
Public Class crIngresoArmas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "syscisepro.crIngresoArmas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrIngresoArmas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crIngresoArmas = New crIngresoArmas()
        rpt.Site = Me.Site
        Return rpt
    End Function
