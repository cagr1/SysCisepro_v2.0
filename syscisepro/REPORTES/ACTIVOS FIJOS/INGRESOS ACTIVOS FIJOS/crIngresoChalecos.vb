...
Public Class crIngresoChalecos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "syscisepro.crIngresoChalecos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrIngresoChalecos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crIngresoChalecos = New crIngresoChalecos()
        rpt.Site = Me.Site
        Return rpt
    End Function
