...
Public Class crIngresoRadios
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "syscisepro.crIngresoRadios.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrIngresoRadios
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crIngresoRadios = New crIngresoRadios()
        rpt.Site = Me.Site
        Return rpt
    End Function
