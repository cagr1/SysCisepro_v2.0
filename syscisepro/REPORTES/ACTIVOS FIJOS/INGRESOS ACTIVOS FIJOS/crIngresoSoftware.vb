...
Public Class crIngresoSoftware
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "syscisepro.crIngresoSoftware.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrIngresoSoftware
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crIngresoSoftware = New crIngresoSoftware()
        rpt.Site = Me.Site
        Return rpt
    End Function
