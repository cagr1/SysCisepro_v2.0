...
Public Class crIngresoTerrenos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "syscisepro.crIngresoTerrenos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrIngresoTerrenos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crIngresoTerrenos = New crIngresoTerrenos()
        rpt.Site = Me.Site
        Return rpt
    End Function
