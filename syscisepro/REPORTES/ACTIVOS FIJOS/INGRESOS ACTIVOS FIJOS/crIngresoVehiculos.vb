...
Public Class crIngresoVehiculos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "syscisepro.crIngresoVehiculos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrIngresoVehiculos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crIngresoVehiculos = New crIngresoVehiculos()
        rpt.Site = Me.Site
        Return rpt
    End Function
