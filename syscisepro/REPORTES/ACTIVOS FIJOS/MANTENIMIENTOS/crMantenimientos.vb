...
Public Class crMantenimientos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "syscisepro.crMantenimientos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrMantenimientos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crMantenimientos = New crMantenimientos()
        rpt.Site = Me.Site
        Return rpt
    End Function
