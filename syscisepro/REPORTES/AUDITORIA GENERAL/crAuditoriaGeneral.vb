...
Public Class crAuditoriaGeneral
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "syscisepro.crAuditoriaGeneral.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrAuditoriaGeneral
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crAuditoriaGeneral = New crAuditoriaGeneral()
        rpt.Site = Me.Site
        Return rpt
    End Function
