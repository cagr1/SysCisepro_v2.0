...
Public Class crCargoOcupacional
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "syscisepro.crCargoOcupacional.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrCargoOcupacional
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crCargoOcupacional = New crCargoOcupacional()
        rpt.Site = Me.Site
        Return rpt
    End Function
