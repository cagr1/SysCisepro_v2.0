...
Public Class crGrupoOcupacional
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "syscisepro.crGrupoOcupacional.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrGrupoOcupacional
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crGrupoOcupacional = New crGrupoOcupacional()
        rpt.Site = Me.Site
        Return rpt
    End Function
