...
Public Class crSerieOcupacional
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "syscisepro.crSerieOcupacional.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrSerieOcupacional
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crSerieOcupacional = New crSerieOcupacional()
        rpt.Site = Me.Site
        Return rpt
    End Function
