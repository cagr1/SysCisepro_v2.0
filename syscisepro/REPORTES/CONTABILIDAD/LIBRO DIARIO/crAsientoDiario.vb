...
Public Class crAsientoDiario
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "syscisepro.crAsientoDiario.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrAsientoDiario
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crAsientoDiario = New crAsientoDiario()
        rpt.Site = Me.Site
        Return rpt
    End Function
