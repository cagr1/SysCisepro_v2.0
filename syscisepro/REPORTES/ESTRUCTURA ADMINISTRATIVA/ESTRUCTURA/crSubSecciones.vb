...
Public Class crSubSecciones
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "syscisepro.crSubSecciones.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrSubSecciones
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crSubSecciones = New crSubSecciones()
        rpt.Site = Me.Site
        Return rpt
    End Function
