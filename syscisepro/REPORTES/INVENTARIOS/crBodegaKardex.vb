...
Public Class crBodegaKardex
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "syscisepro.crBodegaKardex.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrBodegaKardex
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crBodegaKardex = New crBodegaKardex()
        rpt.Site = Me.Site
        Return rpt
    End Function
