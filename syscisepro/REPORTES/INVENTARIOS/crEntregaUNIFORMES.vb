...
Public Class crEntregaUNIFORMES
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "syscisepro.crEntregaUNIFORMES.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrEntregaUNIFORMES
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crEntregaUNIFORMES = New crEntregaUNIFORMES()
        rpt.Site = Me.Site
        Return rpt
    End Function
