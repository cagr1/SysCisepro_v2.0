...
Public Class crItemsBodega
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "syscisepro.crItemsBodega.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrItemsBodega
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crItemsBodega = New crItemsBodega()
        rpt.Site = Me.Site
        Return rpt
    End Function
