...
Public Class crKardexBodega
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "syscisepro.crKardexBodega.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrKardexBodega
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crKardexBodega = New crKardexBodega()
        rpt.Site = Me.Site
        Return rpt
    End Function
