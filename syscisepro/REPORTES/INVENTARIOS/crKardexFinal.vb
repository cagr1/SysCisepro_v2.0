...
Public Class crKardexFinal
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "syscisepro.crKardexFinal.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrKardexFinal
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crKardexFinal = New crKardexFinal()
        rpt.Site = Me.Site
        Return rpt
    End Function
