...
Public Class rptDobladasDiarias
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "syscisepro.rptDobladasDiarias.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptDobladasDiarias
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptDobladasDiarias = New rptDobladasDiarias()
        rpt.Site = Me.Site
        Return rpt
    End Function
