...
Public Class rptRegistroSanciones
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptRegistroSanciones.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "syscisepro.rptRegistroSanciones.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptRegistroSanciones
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptRegistroSanciones = New rptRegistroSanciones()
        rpt.Site = Me.Site
        Return rpt
    End Function
