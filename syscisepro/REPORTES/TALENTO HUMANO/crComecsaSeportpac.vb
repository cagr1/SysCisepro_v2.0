...
Public Class crComecsaSeportpac
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "syscisepro.crComecsaSeportpac.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrComecsaSeportpac
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crComecsaSeportpac = New crComecsaSeportpac()
        rpt.Site = Me.Site
        Return rpt
    End Function
