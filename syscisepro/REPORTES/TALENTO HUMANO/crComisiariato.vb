...
Public Class crComisiariato
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "syscisepro.crComisiariato.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrComisiariato
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crComisiariato = New crComisiariato()
        rpt.Site = Me.Site
        Return rpt
    End Function
