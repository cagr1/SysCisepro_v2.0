...
Public Class crCredencialExport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "syscisepro.crCredencialExport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrCredencialExport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crCredencialExport = New crCredencialExport()
        rpt.Site = Me.Site
        Return rpt
    End Function
