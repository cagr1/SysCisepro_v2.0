...
Public Class crFichaPersonal
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "syscisepro.crFichaPersonal.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrFichaPersonal
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crFichaPersonal = New crFichaPersonal()
        rpt.Site = Me.Site
        Return rpt
    End Function
